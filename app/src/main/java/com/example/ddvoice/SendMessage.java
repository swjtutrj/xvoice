...
//
//import static com.example.ddvoice.MainAppKt.speak;
//
...
//    	    	 if(number == null)
//    	         {
//    	           speak("通讯录没有找到"+mPerson, false);
//    	         }else{
//    	        	 if((mcontent==null)||(mcontent.equals(""))){
//    	     			mActivity.Companion.setServiceFlag(true);
//    	     			speak("你要发送什么内容呢？", false);
//    	     			//mActivity.startSpeenchRecognition();
//    	     			//
//    	     			Thread mThread= new Thread(){
//    	     				public void run(){
//    	     					while((mActivity.Companion.getSRResult() ==null)||(mActivity.Companion
//                                .getSRResult().equals(""))){
//    	     						//空转
//    	     					}
//    	     					//speak("线程中", false);
//    	     					mcontent= mActivity.Companion.getSRResult();
...
//    	                         }
//    	         	        	 mActivity.Companion.setServiceFlag(false);
//    	     				}
//    	     			};
//    	     			mThread.start();
//    	     			//mThread.destroy();
